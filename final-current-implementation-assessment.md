...
| Redaction | dry-run 대상 0건, daily cron은 등록됨 |
| Medications | 847건, `item_seq` 847건 |
| 약품 주요 누락 | 효능/복용법/주의사항/보관법 각 4건 |
| DUR | `sync_dur_known_medications` cursor 52/847 진행 |
...
- 아직 전체 847개 약품에 대해 DUR batch를 모두 돌린 것은 아니다.
...
| DUR 상호작용 | 보통 이상 | 최신 endpoint 수정 및 batch 적재 가능, cursor 52/847 진행 중 |
